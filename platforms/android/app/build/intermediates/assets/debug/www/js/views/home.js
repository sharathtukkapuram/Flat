    ...
    var home = view.extend({
        ...
        loadDashboard: function () {
            ...
            if (len > 0) {
                ...
                // var html = "<div class='row'><div class='col-xs-4'><button id='meetings' class='btn btn-primary button'>Meetings</button></div><div class='col-xs-4'><button id='sahiya' class='btn btn-primary button'>Sahiya</button></div><div class='col-xs-4'><button id='refresh' class='btn btn-primary button'>Refresh</button></div></div></hr><div class='row'><div class='col-sm-12'><h3><strong> </strong><h3></div></div>";
                for (i = 0; i < len; i++) {
                    if (i % 2 == 0) {
